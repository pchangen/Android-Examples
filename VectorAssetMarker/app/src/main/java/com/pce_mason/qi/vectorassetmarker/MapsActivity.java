package com.pce_mason.qi.vectorassetmarker;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        int YOUR_COLOR = Color.argb(160,178,100,66);
        float ZOOM_LEVEL_RATE = 1.6f;
        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(-34, 151);

        mMap.addMarker(new MarkerOptions()
                .icon(bitmapDescriptorFromVector(this,R.drawable.marker_circle_24dp, YOUR_COLOR, ZOOM_LEVEL_RATE ))
    ...
    //////////////////////////////////////////////////////////////////////////
    //    Please insert your Google map key int values/google_map_api.xml   //
    //////////////////////////////////////////////////////////////////////////
